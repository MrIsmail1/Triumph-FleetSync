...
export interface VerificationCodeRepository {
  ...
  findUnexpired(conditions: Partial<VerificationCodeEntity>): Promise<VerificationCodeEntity | null>;
  countPasswordResetAttempts(conditions: Partial<VerificationCodeEntity>): Promise<number>;
