...
const config = {
  ...
  "inlineSchemaHash": "bfd367429e4e7629e5897d8d82a9fb11b8cc762485956e3e4b6b8cade0324a4e",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "../../database/prisma/generated/client-deno",
    "../database/prisma/generated/client-deno",
  ]
...
path.join(process.cwd(), "../../database/prisma/generated/client-deno/libquery_engine-linux-arm64-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../../database/prisma/generated/client-deno/schema.prisma")
